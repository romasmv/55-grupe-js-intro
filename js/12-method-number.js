...
*/ 
// number.MAX_SAFE_INTEGER - Grazina didziausia saugi reiksme, kuri gali buti saugoma skaiciuje (2^53 - 1)
// number.MIN_SAFE_INTEGER - Grazina maziausia saugi reiksme, kuri gali buti saugoma skaiciuje (-(2^53 - 1))
// number.isFinite() - Grazina, ar skicius yra baigtinis
// number.isInteger() - Grazina, ar skicius yra sveikasis
// number.isNaN() - Grazina, ar skicius yra NaN
// number.parseFloat() - is Stringo("skaiciaus" tipo) Grazina sveikaji skaiciu ir po kablialio desimtainius skaičius
// number.parseInt() - is Stringo("skaiciaus" tipo) Grazina sveikieji skaičiu (visada "skaiciaus" tipo Stringa)
// numer.Epsilon() - Grazina maziausia reiksme, kuri gali buti laikoma 0 (skaiciuoja paklaidas intervalam)
// number.toFixed() - Grazina skaiciu su nurodytu desimtainiu tikslumu (kiek skaiciu po kablialio nurodai --> () ) padaro "Stingo" tipa butinai rezultata parseFloat() kad padaryti skaiciu.
